    ...
    <div class="max-w-4xl w-full space-y-8">
        ...
        <form action="{{ route('subscription.activate-plan') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-{{ $showTrial ? '3' : '2' }} gap-6">
                @if($showTrial)
                <!-- Free Trial Plan -->
                <div class="bg-white shadow-lg rounded-lg overflow-hidden border-2 border-indigo-500 relative">
                    <div class="absolute top-0 right-0 bg-indigo-500 text-white px-3 py-1 text-xs font-medium rounded-bl-lg">
                        RECOMMENDED
                    </div>
                    <div class="px-6 py-8">
                        <h3 class="text-2xl font-bold text-gray-900 text-center">Free Trial</h3>
                        <div class="mt-4 text-center">
                            <span class="text-4xl font-bold text-indigo-600">FREE</span>
                        ...
                        <ul class="mt-8 space-y-4">
                            <li class="flex items-center">
                                ...
                                <span class="ml-3 text-gray-700">Full access to all features</span>
                            </li>
                            <li class="flex items-center">
                                <svg class="h-5 w-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                                </svg>
                                <span class="ml-3 text-gray-700">Create unlimited projects</span>
                            </li>
                            <li class="flex items-center">
                                <svg class="h-5 w-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                                </svg>
                                <span class="ml-3 text-gray-700">Manage inquiries & QR codes</span>
                            </li>
                            <li class="flex items-center">
                                <svg class="h-5 w-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                                </svg>
                                <span class="ml-3 text-gray-700">No payment required</span>
                            </li>
                        </ul>
                    </div>
                ...
                <!-- Paid Plans -->
                <div class="bg-white shadow-lg rounded-lg overflow-hidden {{ !$showTrial && $loop->first ? 'border-2 border-indigo-500 relative' : '' }}">
